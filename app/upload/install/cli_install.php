...
// DIR
define('DIR_APPLICATION', str_replace('\\', '/', dirname(__FILE__)) . '/');
define('DIR_SYSTEM', str_replace('\\', '/', dirname(dirname(__FILE__))) . '/system/');
define('DIR_OPENCART', str_replace('\\', '/', dirname(dirname(__FILE__))) . '/');
